// can_grabber_action_client: minimalist client
// wsn, November, 2016
...
void set_can_frames(geometry_msgs::PoseStamped &object_poseStamped,
    ...
    object_poseStamped.pose.position.z = 0.9; //-0.125; //pose w/rt world frame
...
int main(int argc, char** argv) {
    ros::init(argc, argv, "can_grabber_action_client");
    ros::NodeHandle nh;
    ...
    set_can_frames(object_pickup_poseStamped, object_dropoff_poseStamped);
